...
function FailurePanel({ projectId }: FailurePanelProps) {
      ...
      <PageHeader
        ...
        actions={
          <div className="flex flex-wrap items-center gap-2.5 rounded-xl border border-border/70 bg-card/85 p-2 shadow-[0_12px_24px_-22px_rgba(19,32,51,0.66)]">
            ...
            <button
              onClick={() => {
                void runCompliance(selectedProjectId || '');
              }}
            ...
            <button
              onClick={() => {
                void runOptimization(selectedProjectId || '');
              }}
