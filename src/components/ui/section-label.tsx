 ...
 * sections — a small leading icon + tracked-out font-display — rather than plain
  ...
  return (
    <div className={cn('mb-2 flex items-center justify-between gap-2', className)}>
      <div className="flex items-center gap-2 text-muted-foreground">
        ...
        <h3 className="text-[11px] font-semibold font-display tracking-[0.14em] text-foreground/80">
          {children}
        </h3>
      </div>
      {trailing}
